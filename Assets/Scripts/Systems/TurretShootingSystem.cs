...
partial struct TurretShootingSystem : ISystem
{
    ...
    ComponentLookup<LocalToWorld> m_LocalToWorldTransformFromEntity;
...
partial struct TurretShoot : IJobEntity
{
    ...
    void Execute(in TurretAspect turret)
    {
        ...
        //cannonBallTransform.Scale = LocalToWorldTransformFromEntity[turret.CannonBallPrefab].Position;
        ECB.SetComponent(instance, new WorldTransform()
        {
